import asyncio
import structlog
from funcoin.messages import create_peers_message, create_block_message, create_ping_message, create_transaction_message
...
class P2PProtocol:
    ...
    async def handle_ping(self, message, writer):
        ...
        peers_message = create_peers_message(self.server.external_ip, self.serverexternal_port,peers)
